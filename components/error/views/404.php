...
if(ACCESS_ALLOWED != 1){
    header('Location: 404');
    exit('HTTP/1.1 404 Requested document not found on this server.');
}
?>
<!doctype html>
<html>
    <head>
        ...
        <style type="text/css">
            ...
            body { 
                background-image:url(<?php echo SITE_IMAGES; ?>broken.png); 
    ...
    <body>
        <div class="content-wrapper">
            <figure class="404-beach">
                <img src="<?php echo SITE_IMAGES; ?>404-beach.svg" alt="404-beach">
            </figure><!-- /.404-beach -->
            <p>This page can not be found <br> <a onclick="window.history.go(-1);" href="javascript:void(0);"><span>Go back</span></a></p>
        </div><!-- /.content-wrapper -->
    </body>
</html>
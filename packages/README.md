...
| `evolvephp/http` | `Evolve\Http\` | HTTP boundary with the Phase 4.1 PSR HTTP interoperability and `MiddlewarePipeline` foundation plus Phase 4.2 route definitions and matching; routing-related routed dispatch, execution-kernel integration and runtime adapters remain deferred. |

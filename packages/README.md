...
| `evolvephp/http` | `Evolve\Http\` | HTTP boundary with the Phase 4.1 PSR HTTP interoperability and `MiddlewarePipeline` foundation; routing, execution-kernel integration and runtime adapters remain deferred. |

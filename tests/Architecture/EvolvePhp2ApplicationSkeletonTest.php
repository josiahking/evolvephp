...
final class EvolvePhp2ApplicationSkeletonTest extends TestCase
{
    ...
    public function testSkeletonIsExcludedFromFrameworkReleaseAndDeptracBoundaries(): void
    {
        ...
        $this->assertArrayNotHasKey('evolvephp/database-contracts', $skeletonManifest['require']);
        $this->assertArrayNotHasKey('evolvephp/database-contracts', $skeletonManifest['require-dev']);
        $this->assertArrayNotHasKey('evolvephp/database-pdo', $skeletonManifest['require']);

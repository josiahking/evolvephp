...
final class EvolvePhp2PackageSkeletonTest extends TestCase
{
    ...
    private function packages()
    {
        return array(
            ...
            array(
                'manifest' => 'packages/bridge-laravel/composer.json',
                'src' => 'packages/bridge-laravel/src',
                'name' => 'evolvephp/bridge-laravel',
                'description' => 'Laravel host Bridge adapter for embedded EvolvePHP 2 delegation.',
            ...
            array(
                ...
                'description' => 'Remote HTTP JSON Bridge protocol and PSR-15 server endpoint for EvolvePHP 2.',
    ...
    private function acceptedPackageSourceInventories()
    {
        return array(
            ...
            'packages/bridge-laravel/src' => array(
            ...
            'packages/bridge-remote/src' => array(
                ...
                'RemoteBridgeResult.php',
                'RemoteBridgeServerHandler.php',
            ),
            ...
            'Doctor/Project/EnvironmentVariablesCheck.php',
            'Doctor/Project/WritablePathsCheck.php',
            ...
            'Doctor/Runtime/PhpVersionCheck.php',
                ...
                'Exception/ExecutionCleanupFailed.php',
            ...
            'packages/insight/src' => array(
                ...
                'Access/DiagnosticAccessPolicy.php',
                'Capture/DefaultDiagnosticRedactor.php',
                'Capture/DeterministicDiagnosticSampler.php',
                'Capture/DiagnosticAttribute.php',
                'Capture/DiagnosticCaptureFilter.php',
                ...
                'Query/DiagnosticBatchSummary.php',
                'Query/DiagnosticQueryService.php',
                ...
                'Storage/DiagnosticEntryAttributeSnapshot.php',
                'Storage/DiagnosticEntrySnapshot.php',
            ...
            'packages/observe/src' => array(
                ...
                'Http/Internal/HttpServerMetricState.php',
                'Http/Internal/HttpServerSpanState.php',
                'Http/Internal/PsrServerRequestPropagationGetter.php',
                'Logging/ExecutionLogCorrelationInstrumentation.php',
                'Logging/LogCorrelation.php',
                'Logging/LogCorrelationProvider.php',
                'MetricCardinalityPolicy.php',
            ...
            'packages/dev-tools/src' => array(
                ...
                'Adoption/DataOwnership.php',
                'Adoption/IntegrationMode.php',
                'Adoption/MigrationManifest.php',
                'Adoption/OwnershipSystem.php',
                'Adoption/RouteOwner.php',
                'Adoption/RouteOwnership.php',
